...
#define OW_GET_IN()   ( PIN(OW_PORT) & _BV(OW_PIN))
#define OW_OUT_LOW()  ( PORT(OW_PORT) &= ~_BV(OW_PIN) )
#define OW_OUT_HIGH() ( PORT(OW_PORT) |= _BV(OW_PIN) )
#define OW_DIR_IN()   ( DDR(OW_PORT) &= ~_BV(OW_PIN) )
#define OW_DIR_OUT()  ( DDR(OW_PORT) |= _BV(OW_PIN) )
